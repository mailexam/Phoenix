...
#
#     PHX_SERVER=true bin/mailexam start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :mailexam, MailexamWeb.Endpoint, server: true
end
...
if login && password && login != "" && password != "" do
...
if config_env() == :prod do
  ...
  config :mailexam, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
